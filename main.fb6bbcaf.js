...
$(".interactive-avatar__link").click(function (e) {
  ...
  var curItem = $this.closest(".review__switch-item");
...
var openItem = function openItem(item) {
  ...
  var contentBlock = container.find(".text__content");
  var textBlock = contentBlock.find(".team__position");
  var reHeight = textBlock.height();
  container.addClass("active");
  contentBlock.height(reHeight);
};

var closeEveryItem = function closeEveryItem(container) {
  var items = container.find('.text__content');
...
var slider = $('.composition__list').bxSlider({
  pager: false,
  controls: false
});
$('.composition-slider__arrow_direction_prev').click(function (e) {
  e.preventDefault();
  slider.goToPrevSlide();
});
$('.composition-slider__arrow_direction_next').click(function (e) {
  e.preventDefault();
